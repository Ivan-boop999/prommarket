...
docker compose --env-file backend/.env exec postgres pg_isready -U superuser -d prommarket
```
...
DATABASE_URL: postgresql://superuser:superpassword@localhost:54329/prommarket?schema=public
```
